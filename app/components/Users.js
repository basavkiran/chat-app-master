...
function Users({ userData, setSelectedChatroom, setShowNotes }) {
  ...
  return (
    <div className="shadow-lg h-screen w-full overflow-auto mt-4 mb-20">
      <div className="flex flex-col lg:flex-row justify-between p-4 space-y-4 mr-4 lg:space-x-2 lg:space-y-0">
        <button
        ...
        <button
          className={`btn btn-outline ${
            showNotes && activeTab === "users" ? "btn-primary" : ""
          }`}
